...
export const Projects = () => {
  ...
  const projects = [
    ...
    // },
    {
      ...
      images: [
        projectImages['miawdoku/miawdoku.jpg'],
        projectImages['miawdoku/miawdoku-2.jpg'],
        projectImages['miawdoku/miawdoku-3.jpg'],
        projectImages['miawdoku/miawdoku-4.jpg'],
        projectImages['miawdoku/miawdoku-5.jpg'],
        projectImages['miawdoku/miawdoku-6.png'],
        projectImages['miawdoku/miawdoku-7.png'],
        projectImages['miawdoku/miawdoku-8.png'],
        projectImages['miawdoku/miawdoku-9.png'],
        projectImages['miawdoku/miawdoku-10.png'],
        projectImages['miawdoku/miawdoku-11.png'],
      ]
    },
    {
      title: "Leap",
